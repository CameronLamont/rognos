...
/**
 * Type for a generic chart measure.  This includes a label definition in the event that the server needs to use the label for the measure (titles, ect...).
 * 
 * <p>Java class for ChartMeasureType2 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ChartMeasureType2">
 *   &lt;complexContent>
...
@XmlType(name = "ChartMeasureType2", propOrder = {

})
@XmlSeeAlso({
    V5_report.V2BubbleChart.V2BubbleMeasure.class
})
public class ChartMeasureType2 {
